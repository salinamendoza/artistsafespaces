...
<div class="min-h-screen bg-white text-brand-black">
  ...
  <div class="max-w-5xl mx-auto px-6 py-8">
    <h1 class="font-display text-2xl font-bold text-brand-black mb-6">New Brief</h1>
    ...
    {:else}
      ...
      <p class="font-mono text-xs text-gray-500 mb-5">
        Activation type: <span class="text-brand-black font-semibold">{selectedType.name}</span>
        · <a href="." class="underline hover:text-brand-black">change</a>
      </p>
      ...
      <form method="POST" class="grid lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-5">
          ...
          <div>
            ...
            <p class="font-mono text-[11px] text-gray-500 mb-1.5">AS standard terms — point of contact, no direct solicitation, confidentiality — are automatically prepended to every brief. Only add clauses specific to this engagement.</p>
