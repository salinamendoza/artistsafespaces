<script lang="ts">
  import { siteConfig, footerLinks } from '$lib/data/site';
</script>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
      ...
      <div>
        ...
        <ul class="space-y-3">
          {#each footerLinks.programs as link}
            <li>
              <a href={link.href} class="text-gray-400 hover:text-brand-yellow transition-colors text-sm">
                {link.label}
              </a>
            </li>
          {/each}
      ...
      <div>
        ...
        <ul class="space-y-3">
          {#each footerLinks.getInvolved as link}
            <li>
              <a href={link.href} class="text-gray-400 hover:text-brand-yellow transition-colors text-sm">
                {link.label}
              </a>
      ...
      <div>
        ...
        <ul class="space-y-3">
          ...
          {/each}
          <li>
            <a href="mailto:{siteConfig.email.general}" class="text-gray-400 hover:text-brand-yellow transition-colors text-sm">
