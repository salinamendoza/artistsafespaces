...
export const footerLinks = {
  programs: [
    { href: '/art-parks', label: 'Art Parks' },
    { href: '/art-parks/sponsors', label: 'Sponsor a Park' },
    { href: '/art-parks/cities', label: 'City Partners' },
    { href: '/art-therapy', label: 'Art Therapy Festival' }
  ],
  getInvolved: [
    { href: '/artists', label: 'For Artists' },
    { href: '/artists/apply', label: 'Apply as Artist' },
    { href: '/partners/apply', label: 'Partner With Us' },
...
export const partnershipInterests = [
  'Sponsor an Art Park',
  'Host Art Therapy Event',
  'Provide Land/Space',
  'General Inquiry'
];

export const whatCitiesProvide = [
...
export const whatCitiesReceive = [
...
export const artistOpportunities = [
